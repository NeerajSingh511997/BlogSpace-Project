				...
				<div class="my-4 container-fluid">
					...
					action="{{ route('post.store') }}" >
						...
						<div class="my-4 form-group">
							...
							<input type="text" class="form-control form-control-lg" id="title" name="title" placeholder="your post title here ..." value="{{ old('$post->title') }}">
							@error('title')
							<div class="my-2">
								<ul class="list-group">
						...
						<div class="my-4 form-group">
							...
							<input type="file" id="featured" class="my-1 form-control form-control-lg" name="featured" placeholder="your post featured image here ..." value="{{ old('featured') }}">
							@error('featured')
							<div class="my-2">
								<ul class="list-group">
									<li class="list-group-item list-group-item-danger">{{ $message }}</li>
						...
						<div class="my-4 form-group">
							...
							<textarea class="form-control form-control-lg" id="content" rows="3" cols="5" name="content" value="{{ old('title') }}"></textarea>
